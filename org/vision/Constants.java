...
public class Constants extends ConstantsBase {
	public static double kBoilerCenterOfTargetHeight = 89.0; // inches
	public static double kGearCenterOfTargetHeight = 33.0;
	...
	public static double kBoilerCameraXOffset = 0;
	public static double kBoilerCameraYOffset = 0.0;
	public static double kBoilerCameraZOffset = 22;
	public static double kBoilerCameraPitchAngleDegrees = 50.20; // Checked on
																	// Avalanche
																	// at
																	// Wilsonville.
																	// (Week 2)
	public static double kBoilerCameraYawAngleDegrees = 0;
	public static double kBoilerCameraDeadband = 0.0;

	public static double kGearCameraXOffset = 1.0;
	public static double kGearCameraYOffset = 1.0;
	public static double kGearCameraZOffset = 33.0;
	public static double kGearCameraPitchAngleDegrees = 90.0; // calibrated 4/22
	public static double kGearCameraYawAngleDegrees = 1.0;
	public static double kGearCameraDeadband = 0.0;
