...
public class ManagedCompressor extends Compressor {
	...
	/**
	 * If the {@link #ManagedCompressor} is being updated automatically and
	 * periodically
	 */
	...
	/**
	 * Creates a new Managed Compressor, which will turn off when the voltage is
	 * below the specified level.
	 * 
	 * @param voltageThreshold
	 *            Voltage to turn off the compressor at
	 */
	 ...
	 *            Voltage to turn off the compressor at
	 * @param Period
	 *            time to wait between on and off values.
	 */
	 ...
	 * Called automatically according to the period value if {@link #UseTimer}
	 * is enabled.
	 */
	public void update() {
