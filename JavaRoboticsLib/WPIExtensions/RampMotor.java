...
/**
 * A subclass of {@link #SpeedController} intended to allow controlled change in
 * power, for safety or voltage regulation.
 */
public class RampMotor implements SpeedController {
	 ...
	 *            Type of motor controller (Jaguar, Victor, Spark, CAN Talon,
	 *            etc.)
	 * @param port
	...
	public void set(double value) {
		...
		boolean accel = (Math.signum(value) == Math.signum(m_power) && Math.abs(value) > Math.abs(m_power))
