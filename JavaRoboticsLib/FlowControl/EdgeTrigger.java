...
public class EdgeTrigger {
	 ...
	 * 
	 * @param trigger
	 *            Current value of the edge triggered state
	 */
	 ...
	 * 
	 * @param trigger
	 *            Current value of edge triggered state
	 * @return Rising Edge
	 */
	...
	/**
	 * Returns true if there is a rising edge, does not update the internal
	 * state
	 * 
	 * @param trigger
	 *            Current value of the edge triggered state
	...
	/**
	 * Returns true if there is a falling edge, does not update the internal
	 * state
	 * 
	 * @param trigger
	 *            Current value of the edge triggered state
