...
public interface EncoderDrive extends TankDrive {
	...
	default public void driveToDistance(double location, double power, boolean brake, double interval)
	...
	default public void driveForDistance(double location, double power, boolean brake, double interval)
			throws InterruptedException {
	...
	default public void driveToDistance(MotionController controller, double location, double tolerance, boolean brake,
			double interval) throws InterruptedException {
	...
	default public void driveForDistance(MotionController controller, double location, double tolerance, boolean brake,
			double interval) throws InterruptedException {
	...
	default public void driveToAtSpeed(MotionController speedController, double speed, double location, boolean brake,
			double interval) throws InterruptedException {
	...
	default public void driveForAtSpeed(MotionController speedController, double speed, double location, boolean brake,
			double interval) throws InterruptedException {
	...
	default public void dynamicSpeedDrive(DynamicDriveDelegate expression, double interval)
			throws InterruptedException {
	...
	default public void dynamicDistanceDrive(DynamicDriveDelegate expression, double interval)
			throws InterruptedException {
	...
	default public void dynamicEncoderDrive(DynamicEncoderDelegate expression, double interval)
			throws InterruptedException {
	...
	default public void dynamicEncoderDrive(DynamicDriveEncoderDelegate expression, double interval)
			throws InterruptedException {
