...
public interface TankDrive {
	...
	public default void driveForTime(double lPower, double rPower, double time, boolean brake, double interval)
	...
	public default void dynamicDriveForTime(DynamicTimedDelegate expression, double time, double interval)
			throws InterruptedException {
		Timer s = new Timer();
		s.start();
