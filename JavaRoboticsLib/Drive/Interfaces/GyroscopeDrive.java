...
public interface GyroscopeDrive extends TankDrive {
	...
	public default void turnToAngle(MotionController controller, double angle, double tolerance, boolean brake,
	...
	public default void turnForAngle(MotionController controller, double angle, double tolerance, boolean brake,
			double interval) throws InterruptedException {
	...
	public default void driveStraightForTime(MotionController correction, double power, double time, boolean brake,
			double interval) throws InterruptedException {
