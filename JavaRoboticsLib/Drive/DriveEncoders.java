...
/**
 * Encapsulates a left and right encoder and provides drive-specific
 * calculations
 */
public class DriveEncoders {
	...
	/**
	 * Initializes both encoders to the channels specified, with the RIGHT
	 * encoder reversed.
	 * 
	 * @param lAChannel
	 *            Left A Channel
	...
	/**
	 * Sets the left and right DistancePerPulse in feet based on wheel diameter
	 * and counts per revolution
	 * 
	 * @param wheelDiameter
