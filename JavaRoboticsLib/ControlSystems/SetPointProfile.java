...
/**
 * A custom profile for a control system. Can be used for any measurable
 * quantity (speed, displacement, time, etc.)
 */
public class SetPointProfile {
	...
	/**
	 * Get the value of the path at the current point with a linear
	 * interpolation between points above and below current point
	 * 
	 * @param currentPoint
	 *            point along the profile to measure
