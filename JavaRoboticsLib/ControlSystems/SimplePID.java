...
public class SimplePID implements MotionController {
	...
	/**
	 * The change in time for this particular PID loop in seconds. Set to
	 * negative to determine dt automatically.
	 */
	 ...
	 *            Derivative Constant
	 * @param min
	 *            Minimum allowed output of the PID loop
	 * @param max
	 *            Maximum allowed output of the PID loop
	 */
	...
	/**
	 * Gets the value of the PID loop, using the point given as the input for
	 * the proportional value
	 * 
	 * @param currentPoint
	 *            current point of the system as read by a sensor
