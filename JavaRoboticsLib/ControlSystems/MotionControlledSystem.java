...
public abstract class MotionControlledSystem {
	...
	/**
	 * The {@link #SpeedController} to be controlled by the
	 * {@link #MotionController}
	 */
	protected SpeedController Motor;

	/**
	 * Positional tolerance of the {@link #SetPoint} , used in the AtSetPoint
	 * property.
	 */
	...
	/**
	 * Returns true if the {@link #Sensor} is at the setpoint within the
	 * specified tolerance
	 */
	...
	/**
	 * Updates the system based on {@link #getSetPoint()}. If the system is in
	 * manual, sets the motor to zero
	 */
	public void Update() {
