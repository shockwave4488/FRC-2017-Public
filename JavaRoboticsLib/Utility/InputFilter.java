...
/**
 * Input filter functionally identical to that in the NI LabVIEW Controller
 * library
 */
public class InputFilter {
	 ...
	 * 
	 * @param value
	 *            Value to update the {@link #InputFilter} with
	...
	/**
	 * Gets the filtered value of the input without pushing a new value to the
	 * internal buffer
	 * 
	 * @return
	 */
